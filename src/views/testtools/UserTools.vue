<template>
  <page-header-wrapper>
    <div id='components-form-demo-advanced-search'>
      <a href='http://localhost:63342/ZhiErTestWorkStations/apollo_tools/rep/rep2/rep002/index.html' target="_blank">测试跳转</a>
...
export default {
  ...
  methods: {
    getUrl() {
      this.$http.get('http://localhost:63343/zhiervueworkstations/public/static/rep002/index.html').then(response => {
        this.html = response.data
      })
    },
    queryUser() {
      getAppUser(this.appUserForm).then(res => {
        {
          console.log(res)
        }
      })
